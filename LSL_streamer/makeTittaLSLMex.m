...
for SDK_version=1:2
    ...
    if isOctave
        ...
        inpArgs = {'-v'
            ...
            fullfile(myDir,'TittaLSLMex','TittaLSLMex.cpp')
            fullfile(myDir,'src','TittaLSL.cpp')
            fullfile(myDir,'..','SDK_wrapper','src','Titta.cpp')
            fullfile(myDir,'..','SDK_wrapper','src','types.cpp')
            fullfile(myDir,'..','SDK_wrapper','src','utils.cpp')
