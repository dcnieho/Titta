...
namespace
{
    ...
    TobiiResearchLicenseValidationResultInfo lookupTobiiResearchLicenseValidationResult(TobiiResearchLicenseValidationResult trl_)
    {
        switch (trl_)
        {
            // the below is code generated by the matlab script tools/TobiiResearchEnumLister.m
        ...
        {
            std::stringstream os;
            os << "TobiiResearchLicenseValidationResult: code " << trl_ << " unknown";
            DoExitWithMsg(os.str());
...
{
    return lookupTobiiResearchLicenseValidationResult(trl_)._cName;
}

std::string TobiiResearchLicenseValidationResultToExplanation(TobiiResearchLicenseValidationResult trl_)
{
    return lookupTobiiResearchLicenseValidationResult(trl_)._cErrorTxt;
}