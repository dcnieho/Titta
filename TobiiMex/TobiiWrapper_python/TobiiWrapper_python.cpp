...
#endif
{
    ...
    py::class_<TobiiMex>(m, "wrapper")
        ...
        .def_property_readonly("firmware_version", [](TobiiMex& instance_) { return instance_.getEyeTrackerInfo("firmwareVersion").firmwareVersion; })
        .def_property_readonly("runtime_version", [](TobiiMex& instance_) { return instance_.getEyeTrackerInfo("runtimeVersion").runtimeVersion; })
