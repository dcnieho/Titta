...
|`init()`|<ol><li>`address`: optional. A specific eyetracker address</li></ol>||Connect to the Tobii eye tracker and initialize it according to the requested settings|
