...
### Windows
Using version [Psychtoolbox 3.0.18.7 release "Experimental Taylor expansion" SP2, released on 2022-04-20](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/tag/3.0.18.7) is recommended for use with both Matlab and GNU Octave. For use with Matlab, at minimum [PsychToolbox version 3.0.16 "Crowning achievement", released on 2020-05-10](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/tag/PTB_Beta-2020-05-10_V3.0.16) is required. Titta has been tested on MATLAB versions R2019a and R2021a. To use Titta with GNU Octave at minimum Octave version 6.4 is required, which also entails at minimum [PsychToolbox version 3.0.18.2, "Ode to the slacktivists SP2", released on 2021-12-03](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/tag/3.0.18.2). The main Titta class, Titta mex and the readme demos have been tested to work on Octave. The breakOut demo does not work due to incomplete classdef support in Octave. **Currently, Octave support on Windows is not available, awaiting PTB switching to a newer Octave version.**

### Linux
Using version [Psychtoolbox 3.0.18.7 release "Experimental Taylor expansion" SP2, released on 2022-04-20](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/tag/3.0.18.7) is recommended, but at minimum [PsychToolbox version 3.0.16 "Crowning achievement", released on 2020-05-10](https://github.com/Psychtoolbox-3/Psychtoolbox-3/releases/tag/PTB_Beta-2020-05-10_V3.0.16) is required. Titta has been tested on MATLAB version R2022a. GNU Octave support has been tested with Octave version 6.4. Titta for Linux is currently built on Ubuntu 22.04, which means it doesn not work out of the box on other Ubuntu releases. See [the TittaMex readme](/TittaMex/README.md) for more information how to make it work on your platform.
