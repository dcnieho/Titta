...
classdef ScreenBasedCalibration    
    ...
    methods
        function calib = ScreenBasedCalibration(new_tracker)
            ...
            if exist(calibration_folder,'dir') == 7 && exist('CalibrationStatus','class') == 0
        ...
        function enter_calibration_mode(calib)
            calib.APIcall('EnterScreenBasedCalibrationMode',calib.EyeTracker.CoreEyeTracker);
        end
        ...
        function leave_calibration_mode(calib)
            calib.APIcall('LeaveScreenBasedCalibrationMode',calib.EyeTracker.CoreEyeTracker);
        end
